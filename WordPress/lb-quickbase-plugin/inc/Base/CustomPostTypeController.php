...
class CustomPostTypeController extends BaseController
{
    ...
    public function setSubpages()
    {
        $this->subpages = array(
            array(
                ...
                'callback' => array( $this->callbacks, 'cptManagerPage' )
            )
        );
    }
    ...
    public function setSettings()
    {
        $args = array(
            $args[] = array(
                'option_group' => 'cpt_option_group',
                'option_name' => 'qb_cpt_admin',
    ...
    public function storeCustomPostTypes()
    {
        ...
        foreach ($options as $option)
        {
            $this->custom_post_types[] = array(
                ...
                'hierarchical'          => false,
                'public'                => (isset($option['public']) && $option['public'] ? true : false),
                'show_ui'               => true,
                'show_in_menu'          => true,
                'menu_position'         => 5,
                ...
                'can_export'            => true,
                'has_archive'           => (isset($option['has_archive']) && $option['has_archive'] ? true : false),
